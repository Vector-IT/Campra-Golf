				...
				<footer>
					<div class="container" style="margin-top:5px;">
						<div class="col-md-10 col-md-offset-1">
                            ...
                            <li><a href="blog-de-viaje.php">News</a></li>
                            <li><a href="contacto.php">Contacto</a></li>	
							</ol>
						</div>
						<div class="col-md-12 text-center">
							<p><span style="text-transform: uppercase; text-align: center; font-family:'FranklinGothic-Book' !important; font-size: 13px;"><a href="index.php"><?php echo $nombAgen;?> 2017</a></span></p>
						</div>
					</div>
				</footer>
