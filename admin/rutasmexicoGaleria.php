...
<head>
	...
	<script type="text/javascript">
	    ...
	    function listar() {
			...
			xmlhttp.open("POST","php/rutasmexicoGaleriaProcesar.php",true);
...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h2>Galer&iacute;a de im&aacute;genes de <?php echo $NombRuta?></h2>
		</div>
		...
		<form class="form-horizontal" id="formulario" method="post" onSubmit="return false;">
			...
			<div class="form-group">
				<div class="col-md-3">
					<input type="button" class="btn btn-primary" onclick="location.href = 'rutasmexico.php';" value="Volver" />
