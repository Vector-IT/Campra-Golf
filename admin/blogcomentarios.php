<?php 
	...
	if (isset($_GET["blog"])) 
		...
		$numeBlog = "1";
	$blog = cargarTabla("SELECT Titulo FROM blog WHERE NumeBlog = {$numeBlog}");
	
	$fila = $blog->fetch_array();
	$blog->free();
	
	$nombBlog = $fila["Titulo"];
	?>
<!DOCTYPE html>
<html>
<head>
	...
	<script type="text/javascript">
		...
		function listar() {
			...
			xmlhttp.send("operacion=10&Numero=<?php echo $numeBlog;?>&Tipo=1");
		}
		...
		function aceptar(){
            ...
            frmData.append("Numero", <?php echo $numeBlog;?>);
...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h2>Comentarios del blog - <?php echo $nombBlog;?></h2>
		</div>
