...
<html lang="es">
	...
	<head>
		...
		<script src="https://use.fontawesome.com/6b62cee439.js"></script>
	...
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v4.0"></script>
		<div class="wrapper top-style">
			...
			<div class="container" style="margin-top:60px; display: none !important;">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1" style="margin-bottom:30px; margin-top: 20px;">
					<h2 class="text-center h1">Campra Golf en las Redes</h2>
					<br/>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4">
								<div class="fb-page" data-href="https://www.facebook.com/CampraGolf" data-tabs="timeline, messages" data-width="" data-height="660px" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false"><blockquote cite="https://www.facebook.com/CampraGolf" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/CampraGolf">Campra Golf</a></blockquote></div>
							</div>
						</div>
					</div>
				</div>
...
?>
      ...
      <script type="text/javascript">
         var feed = new Instafeed({
               get: 'user',
               userId: '4168649305',
               clientId: 'c9743122dcc14876af85af8fd699404a',
               accessToken: '4168649305.c974312.faf1ef6bfd8242e9ab34901b5810448e',
               template: '<a href="{{link}}" target="_blank"><img class="thumbInsta" style="padding: 2.5px; width: 100%; height: auto;" src="{{image}}" /><br/><span class="likes" style="font-size: 12px; opacity: 0.6;">{{likes}} <i class="fa fa-heart"></i></span><span class="comments" style="font-size: 12px; opacity: 0.6;">{{comments}} <i class="fa fa-comment"></i></span></a>',
               sortBy: 'most-recent',
               limit: '4',
